...
INSERT INTO `city` (`ID`, `CITY_NAME`, `COUNTRY_CODE`, `DISTRICT`, `POPULATION`) VALUES
...
(61, 'South Hill', 'AIA', 'South Hill', 961),
(62, 'The Valley', 'AIA', 'The Valley', 595),
...
(129, 'Oranjestad', 'ABW', 'Oranjestad', 29034),
...
(920, 'Tamuning', 'GUM', 'Tamuning', 9500),
(921, 'Agaña', 'GUM', 'Agaña', 1139),
...
(1791, 'Flying Fish Cove', 'CXR', 'Flying Fish Cove', 700),
...
(2694, 'Monte-Carlo', 'MCO', 'Monte-Carlo', 13154),
(2695, 'Monaco-Ville', 'MCO', 'Monaco-Ville', 1234),
...
(2727, 'Yangor', 'NRU', 'Yangor', 4050),
(2728, 'Yaren', 'NRU', 'Yaren', 559),
...
(2805, 'Alofi', 'NIU', 'Alofi', 682),
(2806, 'Kingston', 'NFK', 'Kingston', 800),
...
(2912, 'Adamstown', 'PCN', 'Adamstown', 42),
...
(3208, 'Singapore', 'SGP', 'Singapore', 4017733),
...
(3285, 'Taiping', 'TWN', 'Taiping', 165524),
...
(3293, 'Taliao', 'TWN', 'Taliao', 115897),
(3294, 'Kueishan', 'TWN', 'Kueishan', 112195),
...
(3538, 'Città del Vaticano', 'VAT', 'Città del Vaticano', 455),
...
(3563, 'Ciudad Losada', 'VEN', 'Ciudad Losada', 134501),
...
INSERT INTO `city_old` (`ID`, `CITY_NAME`, `COUNTRY_CODE`, `DISTRICT`, `POPULATION`) VALUES
(1, 'Kabul', 'AFG', 'Kabol', 1780000),
(2, 'Qandahar', 'AFG', 'Qandahar', 237500),
(3, 'Herat', 'AFG', 'Herat', 186800),
(4, 'Mazar-e-Sharif', 'AFG', 'Balkh', 127800),
...
CREATE TABLE `country` (
  ...
  `YEAR_INDEPENDENCE` int(11) DEFAULT NULL,
  `POPULATION` int(11) DEFAULT NULL,
  `LIFE_EXPECTENCY` float DEFAULT NULL,
  `GNP` float DEFAULT NULL,
  `GNP_OLD` float DEFAULT NULL,
  `LOCAL_NAME` varchar(50) DEFAULT NULL,
  `POLITICAL_SYSTEM` varchar(50) DEFAULT NULL,
  `POLITICAL_RULER` varchar(50) DEFAULT NULL,
  `CAPITAL` int(11) DEFAULT NULL,
  `ISO_3166` char(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `country` (`COUNTRY_CODE`, `COUNTRY_NAME`, `CONTINENT`, `TIME_ZONE`, `SURFACE_AREA`, `YEAR_INDEPENDENCE`, `POPULATION`, `LIFE_EXPECTENCY`, `GNP`, `GNP_OLD`, `LOCAL_NAME`, `POLITICAL_SYSTEM`, `POLITICAL_RULER`, `CAPITAL`, `ISO_3166`) VALUES
...
('AFG', 'Afghanistan', 'Asia', 'Southern and Central', 652090, 1919, 22720000, 45.9, 5976, NULL, 'Afganistan/Afqanestan', 'Islamic Emirate', 'Mohammad Omar', 1, 'AF'),
...
('BGD', 'Bangladesh', 'Asia', 'Southern and Central', 143998, 1971, 129155000, 60.2, 32852, 31966, 'Bangladesh', 'Republic', 'Shahabuddin Ahmad', 150, 'BD'),
...
('BTN', 'Bhutan', 'Asia', 'Southern and Central', 47000, 1910, 2124000, 52.4, 372, 383, 'Druk-Yul', 'Monarchy', 'Jigme Singye Wangchuk', 192, 'BT'),
...
('IND', 'India', 'Asia', 'Southern and Central', 3287260, 1947, 1013662000, 62.5, 447114, 430572, 'Bharat/India', 'Federal Republic', 'Kocheril Raman Narayanan', 1109, 'IN'),
...
('IRN', 'Iran', 'Asia', 'Southern and Central', 1648200, 1906, 67702000, 69.7, 195746, 160151, 'Iran', 'Islamic Republic', 'Ali Mohammad Khatami-Ardakani', 1380, 'IR'),
...
('KAZ', 'Kazakstan', 'Asia', 'Southern and Central', 2724900, 1991, 16223000, 63.2, 24375, 23383, 'Qazaqstan', 'Republic', 'Nursultan Nazarbajev', 1864, 'KZ'),
('KEN', 'Kenya', 'Africa', 'Eastern Africa', 580367, 1963, 30080000, 48, 9217, 10241, 'Kenya', 'Republic', 'Daniel arap Moi', 1881, 'KE'),
('KGZ', 'Kyrgyzstan', 'Asia', 'Southern and Central', 199900, 1991, 4699000, 63.4, 1626, 1767, 'Kyrgyzstan', 'Republic', 'Askar Akajev', 2253, 'KG'),
...
('LKA', 'Sri Lanka', 'Asia', 'Southern and Central', 65610, 1948, 18827000, 71.8, 15706, 15091, 'Sri Lanka/Ilankai', 'Republic', 'Chandrika Kumaratunga', 3217, 'LK'),
...
('MDV', 'Maldives', 'Asia', 'Southern and Central', 298, 1965, 286000, 62.2, 199, NULL, 'Dhivehi Raajje/Maldives', 'Republic', 'Maumoon Abdul Gayoom', 2463, 'MV'),
...
('NPL', 'Nepal', 'Asia', 'Southern and Central', 147181, 1769, 23930000, 57.8, 4768, 4837, 'Nepal', 'Constitutional Monarchy', 'Gyanendra Bir Bikram', 2729, 'NP'),
...
('PAK', 'Pakistan', 'Asia', 'Southern and Central', 796095, 1947, 156483000, 61.1, 61289, 58549, 'Pakistan', 'Republic', 'Mohammad Rafiq Tarar', 2831, 'PK'),
...
('TJK', 'Tajikistan', 'Asia', 'Southern and Central', 143100, 1991, 6188000, 64.1, 1990, 1056, 'Toçikiston', 'Republic', 'Emomali Rahmonov', 3261, 'TJ'),
...
('TKM', 'Turkmenistan', 'Asia', 'Southern and Central', 488100, 1991, 4459000, 60.9, 4397, 2000, 'Türkmenostan', 'Republic', 'Saparmurad Nijazov', 3419, 'TM'),
...
('UZB', 'Uzbekistan', 'Asia', 'Southern and Central', 447400, 1991, 24318000, 63.7, 14194, 21300, 'Uzbekiston', 'Republic', 'Islam Karimov', 3503, 'UZ'),
...
INSERT INTO `country_old` (`COUNTRY_CODE`, `COUNTRY_NAME`, `CONTINENT`, `TIME_ZONE`, `SURFACE_AREA`, `YEAR_INDEPENDENCE`, `POPULATION`, `LIFE_EXPECTENCY`, `GNP`, `GNP_OLD`, `LOCAL_NAME`, `POLITICAL_SYSTEM`, `POLITICAL_RULER`, `CAPITAL`, `ISO_3166`) VALUES
('ABW', 'Aruba', 'North America', 'Caribbean', 193, NULL, 103000, 78.4, 828, 793, 'Aruba', 'Nonmetropolitan Territory of The Netherlands', 'Beatrix', 129, 'AW'),
('AFG', 'Afghanistan', 'Asia', 'Southern and Central', 652090, 1919, 22720000, 45.9, 5976, NULL, 'Afganistan/Afqanestan', 'Islamic Emirate', 'Mohammad Omar', 1, 'AF'),
('AGO', 'Angola', 'Africa', 'Central Africa', 1246700, 1975, 12878000, 38.3, 6648, 7984, 'Angola', 'Republic', 'José Eduardo dos Santos', 56, 'AO'),
('AIA', 'Anguilla', 'North America', 'Caribbean', 96, NULL, 8000, 76.1, 63.2, NULL, 'Anguilla', 'Dependent Territory of the UK', 'Elisabeth II', 62, 'AI'),
...
CREATE TABLE `lang` (
  ...
  `OFFICIAL_LANG` char(1) DEFAULT NULL,
...
INSERT INTO `lang` (`COUNTRY_CODE`, `LANG`, `OFFICIAL_LANG`, `PERCENTAGE`) VALUES
('ABW', 'Dutch', 'T', 5.3),
('ABW', 'English', 'F', 9.5),
...
--
-- Table structure for table `lang_exists`
--

CREATE TABLE `lang_exists` (
  `LANG` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `lang_exists`
--

INSERT INTO `lang_exists` (`LANG`) VALUES
('Dutch'),
('English'),
('Papiamento'),
('Spanish'),
...
--
-- Table structure for table `lang_old`
--

CREATE TABLE `lang_old` (
  `COUNTRY_CODE` char(3) NOT NULL,
  `LANG` varchar(30) NOT NULL,
  `OFFICIAL_LANG` char(1) DEFAULT NULL,
  `PERCENTAGE` float DEFAULT NULL
...
--
-- Dumping data for table `lang_old`
--

INSERT INTO `lang_old` (`COUNTRY_CODE`, `LANG`, `OFFICIAL_LANG`, `PERCENTAGE`) VALUES
('ABW', 'Dutch', 'T', 5.3),
('ABW', 'English', 'F', 9.5),
('ABW', 'Papiamento', 'F', 76.7),
('ABW', 'Spanish', 'F', 7.4),
...
--
ALTER TABLE `lang`
  ADD PRIMARY KEY (`COUNTRY_CODE`,`LANG`);

ALTER TABLE `lang_exists`
...
--
ALTER TABLE `city`
  ADD CONSTRAINT `city_ibfk_1` FOREIGN KEY (`COUNTRY_CODE`) REFERENCES `country` (`COUNTRY_CODE`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `country`
--
ALTER TABLE `country`
  ADD CONSTRAINT `country_ibfk_1` FOREIGN KEY (`CAPITAL`) REFERENCES `city` (`ID`) ON DELETE SET NULL ON UPDATE CASCADE;
--
-- Constraints for table `lang`
--
ALTER TABLE `lang`
  ADD CONSTRAINT `lang_ibfk_1` FOREIGN KEY (`COUNTRY_CODE`) REFERENCES `country` (`COUNTRY_CODE`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;

ALTER TABLE `lang`
  ADD CONSTRAINT `lang_ibfk_2` FOREIGN KEY (`LANG`) REFERENCES `lang_exists` (`LANG`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
