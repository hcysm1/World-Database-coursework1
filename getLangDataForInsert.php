...
<form id ="edit_lang" action="lang.php" method="post">
              ...
              <?php
              $sql = "SELECT COUNTRY_NAME,COUNTRY_CODE FROM country WHERE COUNTRY_CODE='$COUNTRY_SELECTED'";
              $result = $db->query($sql);
              ...
              ?>
              <?php
              $sql = "SELECT COUNTRY_NAME,COUNTRY_CODE FROM country WHERE NOT COUNTRY_CODE='$COUNTRY_SELECTED'";
              $result = $db->query($sql);
              while ($rs=$result-> fetch_assoc())
              {
              ?>
  ...
  <?php
  $sqlgetlang = "SELECT * FROM lang_exists WHERE NOT EXISTS(SELECT * FROM lang WHERE lang.LANG=lang_exists.LANG AND lang.COUNTRY_CODE='$COUNTRY_SELECTED')";
